...
export default function AnalyticsPage() {
  ...
  if (error) return <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-6 text-red-100">Analytics could not be loaded from local planner data.</div>;

  return (
    <div className="grid gap-5">
      <div>
        <h1 className="text-2xl font-semibold">Analytics</h1>
        <p className="text-sm text-muted-foreground">Study hours, completion, readiness, streak, and topic heatmap are calculated from local planner activity.</p>
      </div>
