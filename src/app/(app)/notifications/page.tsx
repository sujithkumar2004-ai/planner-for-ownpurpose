...
export default function NotificationsPage() {
  ...
  if (error) return <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-6 text-red-100">Notifications could not be loaded from local planner data.</div>;

  return (
    <div className="grid gap-5">
      <div>
        <h1 className="text-2xl font-semibold">Notification Center</h1>
        <p className="text-sm text-muted-foreground">Daily reminders, overdue alerts, exam countdowns, and weekly review signals are generated from local Life OS data.</p>
      </div>
