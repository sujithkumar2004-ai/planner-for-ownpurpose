...
export default function SettingsPage() {
  ...
  if (error) return <div className="rounded-lg border border-red-500/20 bg-red-500/10 p-6 text-red-100">Settings could not be loaded from local planner data.</div>;

  return (
    <div className="grid gap-5">
      <div>
        <h1 className="text-2xl font-semibold">Settings</h1>
        <p className="text-sm text-muted-foreground">Exam selection, daily capacity, travel preferences, notifications, and date overrides are stored in this browser.</p>
      </div>
      <Card>
